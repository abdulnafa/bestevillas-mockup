...
function publicUrl(pathValue = "", basePath = "/") {
  ...
  const cacheVersion = path === "script.js" ? "?v=20260925-1" : "";
  return `${basePath}${path}${cacheVersion}`.replace(/\/{2,}/g, "/");
}
